...
double scalarDataWrapper::operator [] ( int i ){	return data[i];}
void   scalarDataWrapper::setMetadata( void* metadata_ ){	metadata = metadata_; }
...
scalarDataWrapper::~scalarDataWrapper(){	delete [] data; }
